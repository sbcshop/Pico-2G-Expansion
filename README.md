...
* To use GET method(thingspeak), uncomment this line  Get = SIM868.get_http(get_server,APN)
* To use POST method(thingspeak),uncomment this line Post = EG25_4G.post_http(post_data,APN,content_type,post_server)
